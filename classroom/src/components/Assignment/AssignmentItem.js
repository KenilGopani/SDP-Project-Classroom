...
const AssignmentItem = (props) => {
  return (
    // <li className='row border border-primary rounded m-2 assignment w-75' style={{backgroundColor:'#D8DFF2'}} >
      <Link to={`/home/classroom/viewassignment/${props.assignment._id}`} className='row border border-primary rounded m-2 assignment w-75' style={{backgroundColor:'#D8DFF2'}}>
        <div className='col-2'>
